package com.khadri.csv.prepare.data.movie.processor;
...
public class MovieDataProcessor {
	...
	public void process(PrintWriter pw, int recordNumber) {
		...
		//System.out.println("Enter TOTAL_Collection : ");
		//double movieCollection = scanner.nextInt();
		...
		String line = id + "," + name + "," + movieBudget + "," + songPrice + "," +  totalCollection + ","
				+ avg + "," + rating;
		pw.println(line);
